...
class Cruds extends BaseController
{
    public function index()
    {
        $models = new MotivasiModel();
        $jumlah = $models->countAllResults();
        $data = [
            'jumlahdata' => $jumlah
        ];
    ...
    public function hapus($id)
    {
        ...
        if ($hapus) {
            session()->setFlashdata('succses', 'Data berhasil di hapus');
            return redirect()->to('/content/data');
        } else {
